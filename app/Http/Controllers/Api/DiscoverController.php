...
class DiscoverController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($data) {
           ...
           return response()->json([
            'success' => false,
            'message' => 'Discover Failed to Save',
        ], 409);
    }
